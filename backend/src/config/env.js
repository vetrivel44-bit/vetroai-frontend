...
// Environment validation is performed during server bootstrap so development
// can still start without optional integrations, while production fails fast
// when authentication secrets are missing.
...
module.exports = {
  ...
  config: {
    ...
    bookingNotificationPhones: getEnv("BOOKING_NOTIFICATION_PHONES", ""),
