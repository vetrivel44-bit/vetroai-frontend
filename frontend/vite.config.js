...
function browserPuterModelsTransform() {
  return {
    ...
    transform(code, id) {
      ...
      next = next.replace(/"Grok 4\.6",\s*"Gemini",\s*"Mistral"/, '"Grok 4.6", "Sonar Pro Research", "Gemini 3.1 Pro", "Gemini 3.7 Flash", "Gemini 3.5 Flash-Lite", "Claude Sonnet 5", "Claude Haiku 4.5", "Claude Opus 5", "Mistral"');
      next = next.replace(/"Grok 4\.6",\s*"Sonar Pro Research",\s*"Gemini",\s*"Mistral"/, '"Grok 4.6", "Sonar Pro Research", "Gemini 3.1 Pro", "Gemini 3.7 Flash", "Gemini 3.5 Flash-Lite", "Claude Sonnet 5", "Claude Haiku 4.5", "Claude Opus 5", "Mistral"');
      next = next.replace(/"Gemini 3\.5 Flash-Lite",\s*"Mistral"/, '"Gemini 3.5 Flash-Lite", "Claude Sonnet 5", "Claude Haiku 4.5", "Claude Opus 5", "Mistral"');
